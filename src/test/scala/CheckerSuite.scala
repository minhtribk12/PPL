...
class CheckerSuite extends FunSuite with TestChecker {
  ...
  test("Redeclared Parameter 121") {
    ...
    int main ( boolean hg,boolean hg,boolean hd){
      int wrong;
      return 0;
    }"""
    val expected = """Redeclared Parameter: hg"""
  ...
  test("Undeclared Identifier 189") {
    val input = """
        int main() {
        int a;
        int b;
