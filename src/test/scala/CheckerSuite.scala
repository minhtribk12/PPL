...
//     }
//     void main(){}
//     int test(int a, int b, int c, int d, int bug, int f, int bug){
//       if (a>2.1)
//             if (b<-1)
//                 if (c == 2)
//                     d = 4;
...
/**
  ...
  */
class CheckerSuite extends FunSuite with TestChecker {
  test("Redeclared Variable: a") {
    val input = "int a; int b; float a;"
    val expected = "Redeclared Variable: a"
    assert(checkCkr(input,expected,401))
  }

  test("Redeclared Parameter: a") {
    val input =
      """
  ...
  test("Redeclared function: test") {
    val input =
      """
        void main(){}
        void test(int a){}
        void test(float a, string b, boolean c, int n[]){}
      """
    val expected ="Redeclared Function: test"
    assert(checkCkr(input,expected,403))
  }
  ...
  test("Redeclared variable inside a function 2") {
    val input =
      """
        void main(int b, boolean isA){
          float b;
        }
      """
    val expected ="Redeclared Variable: b"
  ...
  test("Type mismatch string to int") {
    val input =
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",Id("a"),StringLiteral("Khoa"))"""
    assert(checkCkr(input,expected,406))
  }

  test("Type mismatch float to int") {
    val input =
      """
        void main(){
          int a;
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",Id("a"),FloatLiteral(2.3f))"""
    assert(checkCkr(input,expected,407))
  }
    ...
    val input = Program(List(
      FuncDecl(Id("main"),List(),VoidType,
        Block(List(),
          List(CallExpr(Id("putIntLn"),List()))))))
    val expected = "Type Mismatch In Expression: "+CallExpr(Id("putIntLn"),List()).toString
    assert(checkAst(input,expected,410))
  }
  test("Check with AST putIntLn with float") {
    ...
    val input = Program(List(
      FuncDecl(Id("main"),List(),VoidType,
        Block(List(),
          List(CallExpr(Id("putIntLn"),List(FloatLiteral(1.2f))))))))
    val expected = "Type Mismatch In Expression: "+CallExpr(Id("putIntLn"),List(FloatLiteral(1.2f))).toString
    assert(checkAst(input,expected,411))

  }

  test("Type mismatch float to string") {
    val input =
      """
        void main(){
          string a;
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",Id("a"),FloatLiteral(2.5f))"""
    assert(checkCkr(input,expected,412))
  }

  test("Type mismatch not int") {
    val input =
      """
        void main(){
          boolean a;
      ...
      """
    val expected ="""Type Mismatch In Expression: UnaryOp("!",BinaryOp("+",IntLiteral(2),IntLiteral(3)))"""
    assert(checkCkr(input,expected,413))
  }

  test("Type mismatch not boolean") {
    val input =
      """
        void main(){
          boolean a;
  ...
  test("Type mismatch not boolean 2") {
    val input =
      """
        void main(){
          boolean a;
  ...
  test("if statement wrong expression") {
    val input =
      """
        void main(){
          int a;
      ...
      """
    val expected ="""Type Mismatch In Statement: If(BinaryOp("+",IntLiteral(2),IntLiteral(3)),BinaryOp("=",Id("a"),IntLiteral(4)),None)"""
    assert(checkCkr(input,expected,416))
  }
  ...
  test("break statement outside for loop") {
    val input =
      """
        void main(){
          int a;
  ...
  test("continue statement outside for loop") {
    val input =
      """
        void main(){
          int a;
  ...
  test("break statement outside while loop") {
    val input =
      """
        void main(){
          int a;
  ...
  test("continue statement outside while loop") {
    val input =
      """
        void main(){
          int a;
  ...
  test("break statement inside while loop") {
    val input =
      """
        void main(){
          int a;
  ...
  test("call function with wrong parameter") {
    val input =
      """
      ...
      """
    val expected ="""Type Mismatch In Expression: CallExpr(Id("test"),List(IntLiteral(3),FloatLiteral(12.6f),IntLiteral(7)))"""
    assert(checkCkr(input,expected,425))
  }

  test("Mismatch return statement") {
    val input =
      """
        int main(){
          int a;
  ...
  test("Mismatch return statement 2") {
    val input =
      """
        int main(){
          int a;
      ...
      """
    val expected ="""Type Mismatch In Statement: Return(Some(BinaryOp("+",FloatLiteral(5.6f),FloatLiteral(1.2f))))"""
    assert(checkCkr(input,expected,427))
  }

  test("Mismatch return statement 3") {
    val input =
      """
        int main(){
          int a;
      ...
      """
    val expected ="""Type Mismatch In Statement: Return(Some(StringLiteral("Correct")))"""
    assert(checkCkr(input,expected,428))
  }

  test("Unreachable statement return") {
    val input =
      """
        void main(){
          int a;
      ...
      """
    val expected ="""Unreachable Statement: BinaryOp("=",Id("a"),IntLiteral(5))"""
    assert(checkCkr(input,expected,431))
  }

  test("Unreachable statement return 2") {
    val input =
      """
        void main(){
          int a;
      ...
      """
    val expected ="""Unreachable Statement: BinaryOp("=",Id("b"),BinaryOp("+",Id("b"),IntLiteral(2)))"""
    assert(checkCkr(input,expected,432))
  }

  test("Unreachable statement return 3") {
    val input =
      """
        void main(){
          int a;
  ...
  test("Unreachable statement return 4") {
    val input =
      """
        void main(){
          int a;
  ...
  test("Unreachable statement return 5") {
    val input =
      """
        void main(){
          int a;
  ...
  test("Unreachable statement return 6") {
    val input =
      """
        void main(){
          int a;
  ...
  test("Function has return in body") {
    val input =
      """
        void main(){
          int a;
  ...
  test("Function has return in if") {
    val input =
      """
        int main(){
          int a;
  ...
  test("Call function") {
    val input =
      """
      void callAnotherFunction(int a){}
      void main(){
        callAnotherFunction(12);
        return;
      }
      """
    val expected =""""""
  ...
  test("Redeclare a global variable") {
    val input =
      """
        float x;
        void callAnotherFunction(int a){}
  ...
  test("Unreachable statement child function") {
    val input =
      """
        int callAnotherFunction(int a){
          if (a == 0)
            return 1;
          else
            return 2;
  ...
  test("return in if without else") {
    val input =
      """
        int callAnotherFunction(int a){
          if (a == 0)
      ...
      """
    val expected ="""Function Not Return: callAnotherFunction"""
    assert(checkCkr(input,expected,445))
  }

  test("Unreachable many Functions"){
    val input =
      """
        
        void callAnotherFunction(int a){}
        void callAnotherFunction3(string a){callAnotherFunction2(3.2);}
        void callAnotherFunction2(float a){callAnotherFunction3("Khoa");}
        void main(){
          callAnotherFunction(12);
        }

      """
    val expected ="""Unreachable Function: callAnotherFunction2"""
    assert(checkCkr(input,expected,446))
  }

  test("Return array pointer 2"){
    val input =
      """
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",Id("a"),CallExpr(Id("execute"),List(IntLiteral(4))))"""
    assert(checkCkr(input,expected,448))
  }

  test("Redeclare function name as var name"){
    val input =
      """
        int a;
        void a(){}
  ...
  test("Invalid type in array pointer (function call)"){
    val input =
      """
        int a;
        void main(){
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",ArrayCell(Id("a"),IntLiteral(1)),IntLiteral(3))"""
    assert(checkCkr(input,expected,451))
  }

  test("Function call return array pointer type"){
    val input =
      """
        int a;
  ...
  test("Type mismatch in function call (return array pointer type)"){
    val input =
      """
        int a;
      ...
      """
    val expected ="""Type Mismatch In Expression: BinaryOp("=",ArrayCell(Id("a"),IntLiteral(0)),ArrayCell(CallExpr(Id("getArray"),List()),IntLiteral(2)))"""
    assert(checkCkr(input,expected,453))
  }
  ...
  test("Complex assignment expression 2"){
    val input =
      """
        int a;
        void main(){
  ...
  test("Complex assignment expression float type"){
    val input =
      """
        float a;
  ...
  test("Complex program 6"){
    val input =
      """
        int test(boolean b, int numbers[], float a){
          if (a < 100)
            if (b)
              return numbers[0];
            else
